...
static const char fmt_none[] = "O\t";
static const char fmt_rs1[] = "O\t1";
static const char fmt_offset[] = "O\to";
static const char fmt_pred_succ[] = "O\tp,s";
static const char fmt_rs1_rs2[] = "O\t1,2";
static const char fmt_rd_imm[] = "O\t0,i";
static const char fmt_rd_offset[] = "O\t0,o";
static const char fmt_rd_rs1_rs2[] = "O\t0,1,2";
static const char fmt_frd_rs1[] = "O\t3,1";
static const char fmt_rd_frs1[] = "O\t0,4";
static const char fmt_rd_frs1_frs2[] = "O\t0,4,5";
static const char fmt_frd_frs1_frs2[] = "O\t3,4,5";
static const char fmt_rm_frd_frs1[] = "O\tr,3,4";
static const char fmt_rm_frd_rs1[] = "O\tr,3,1";
static const char fmt_rm_rd_frs1[] = "O\tr,0,4";
static const char fmt_rm_frd_frs1_frs2[] = "O\tr,3,4,5";
static const char fmt_rm_frd_frs1_frs2_frs3[] = "O\tr,3,4,5,6";
static const char fmt_rd_rs1_imm[] = "O\t0,1,i";
static const char fmt_rd_rs1_offset[] = "O\t0,1,i";
static const char fmt_rd_offset_rs1[] = "O\t0,i(1)";
static const char fmt_frd_offset_rs1[] = "O\t3,i(1)";
static const char fmt_rd_csr_rs1[] = "O\t0,c,1";
static const char fmt_rd_csr_zimm[] = "O\t0,c,7";
static const char fmt_rs2_offset_rs1[] = "O\t2,i(1)";
static const char fmt_frs2_offset_rs1[] = "O\t5,i(1)";
static const char fmt_rs1_rs2_offset[] = "O\t1,2,o";
static const char fmt_rs2_rs1_offset[] = "O\t2,1,o";
static const char fmt_aqrl_rd_rs2_rs1[] = "OAR\t0,2,(1)";
static const char fmt_aqrl_rd_rs1[] = "OAR\t0,(1)";
static const char fmt_rd[] = "O\t0";
static const char fmt_rd_zimm[] = "O\t0,7";
static const char fmt_rd_rs1[] = "O\t0,1";
static const char fmt_rd_rs2[] = "O\t0,2";
static const char fmt_rs1_offset[] = "O\t1,o";
static const char fmt_rs2_offset[] = "O\t2,o";
...
const rv_opcodeData opcode_data[] = {
    {"illegal", type_illegal, fmt_none, NULL, 0, 0, 0},
    {"lui", type_u, fmt_rd_imm, NULL, 0, 0, 0},
    {"auipc", type_u, fmt_rd_offset, NULL, 0, 0, 0},
    {"jal", type_uj, fmt_rd_offset, rvcp_jal, 0, 0, 0},
    {"jalr", type_i, fmt_rd_rs1_offset, rvcp_jalr, 0, 0, 0},
    {"beq", type_sb, fmt_rs1_rs2_offset, rvcp_beq, 0, 0, 0},
    {"bne", type_sb, fmt_rs1_rs2_offset, rvcp_bne, 0, 0, 0},
    {"blt", type_sb, fmt_rs1_rs2_offset, rvcp_blt, 0, 0, 0},
    {"bge", type_sb, fmt_rs1_rs2_offset, rvcp_bge, 0, 0, 0},
    {"bltu", type_sb, fmt_rs1_rs2_offset, rvcp_bltu, 0, 0, 0},
    {"bgeu", type_sb, fmt_rs1_rs2_offset, rvcp_bgeu, 0, 0, 0},
    {"lb", type_i, fmt_rd_offset_rs1, NULL, 0, 0, 0},
    {"lh", type_i, fmt_rd_offset_rs1, NULL, 0, 0, 0},
    {"lw", type_i, fmt_rd_offset_rs1, NULL, 0, 0, 0},
    {"lbu", type_i, fmt_rd_offset_rs1, NULL, 0, 0, 0},
    {"lhu", type_i, fmt_rd_offset_rs1, NULL, 0, 0, 0},
    {"sb", type_s, fmt_rs2_offset_rs1, NULL, 0, 0, 0},
    {"sh", type_s, fmt_rs2_offset_rs1, NULL, 0, 0, 0},
    {"sw", type_s, fmt_rs2_offset_rs1, NULL, 0, 0, 0},
    {"addi", type_i, fmt_rd_rs1_imm, rvcp_addi, 0, 0, 0},
    {"slti", type_i, fmt_rd_rs1_imm, NULL, 0, 0, 0},
    {"sltiu", type_i, fmt_rd_rs1_imm, rvcp_sltiu, 0, 0, 0},
    {"xori", type_i, fmt_rd_rs1_imm, rvcp_xori, 0, 0, 0},
    {"ori", type_i, fmt_rd_rs1_imm, NULL, 0, 0, 0},
    {"andi", type_i, fmt_rd_rs1_imm, NULL, 0, 0, 0},
    {"slli", type_i_sh7, fmt_rd_rs1_imm, NULL, 0, 0, 0},
    {"srli", type_i_sh7, fmt_rd_rs1_imm, NULL, 0, 0, 0},
    {"srai", type_i_sh7, fmt_rd_rs1_imm, NULL, 0, 0, 0},
    {"add", type_r, fmt_rd_rs1_rs2, NULL, 0, 0, 0},
    {"sub", type_r, fmt_rd_rs1_rs2, rvcp_sub, 0, 0, 0},
    {"sll", type_r, fmt_rd_rs1_rs2, NULL, 0, 0, 0},
    {"slt", type_r, fmt_rd_rs1_rs2, rvcp_slt, 0, 0, 0},
    {"sltu", type_r, fmt_rd_rs1_rs2, rvcp_sltu, 0, 0, 0},
    {"xor", type_r, fmt_rd_rs1_rs2, NULL, 0, 0, 0},
    {"srl", type_r, fmt_rd_rs1_rs2, NULL, 0, 0, 0},
    {"sra", type_r, fmt_rd_rs1_rs2, NULL, 0, 0, 0},
    {"or", type_r, fmt_rd_rs1_rs2, NULL, 0, 0, 0},
    {"and", type_r, fmt_rd_rs1_rs2, NULL, 0, 0, 0},
    {"fence", type_r_f, fmt_pred_succ, NULL, 0, 0, 0},
    {"fence.i", type_none, fmt_none, NULL, 0, 0, 0},
    {"lwu", type_i, fmt_rd_offset_rs1, NULL, 0, 0, 0},
    {"ld", type_i, fmt_rd_offset_rs1, NULL, 0, 0, 0},
    {"sd", type_s, fmt_rs2_offset_rs1, NULL, 0, 0, 0},
    {"addiw", type_i, fmt_rd_rs1_imm, rvcp_addiw, 0, 0, 0},
    {"slliw", type_i_sh5, fmt_rd_rs1_imm, NULL, 0, 0, 0},
    {"srliw", type_i_sh5, fmt_rd_rs1_imm, NULL, 0, 0, 0},
    {"sraiw", type_i_sh5, fmt_rd_rs1_imm, NULL, 0, 0, 0},
    {"addw", type_r, fmt_rd_rs1_rs2, NULL, 0, 0, 0},
    {"subw", type_r, fmt_rd_rs1_rs2, rvcp_subw, 0, 0, 0},
    {"sllw", type_r, fmt_rd_rs1_rs2, NULL, 0, 0, 0},
    {"srlw", type_r, fmt_rd_rs1_rs2, NULL, 0, 0, 0},
    {"sraw", type_r, fmt_rd_rs1_rs2, NULL, 0, 0, 0},
    {"ldu", type_i, fmt_rd_offset_rs1, NULL, 0, 0, 0},
    {"lq", type_i, fmt_rd_offset_rs1, NULL, 0, 0, 0},
    {"sq", type_s, fmt_rs2_offset_rs1, NULL, 0, 0, 0},
    {"addid", type_i, fmt_rd_rs1_imm, NULL, 0, 0, 0},
    {"sllid", type_i_sh6, fmt_rd_rs1_imm, NULL, 0, 0, 0},
    {"srlid", type_i_sh6, fmt_rd_rs1_imm, NULL, 0, 0, 0},
    {"sraid", type_i_sh6, fmt_rd_rs1_imm, NULL, 0, 0, 0},
    {"addd", type_r, fmt_rd_rs1_rs2, NULL, 0, 0, 0},
    {"subd", type_r, fmt_rd_rs1_rs2, NULL, 0, 0, 0},
    {"slld", type_r, fmt_rd_rs1_rs2, NULL, 0, 0, 0},
    {"srld", type_r, fmt_rd_rs1_rs2, NULL, 0, 0, 0},
    {"srad", type_r, fmt_rd_rs1_rs2, NULL, 0, 0, 0},
    {"mul", type_r, fmt_rd_rs1_rs2, NULL, 0, 0, 0},
    {"mulh", type_r, fmt_rd_rs1_rs2, NULL, 0, 0, 0},
    {"mulhsu", type_r, fmt_rd_rs1_rs2, NULL, 0, 0, 0},
    {"mulhu", type_r, fmt_rd_rs1_rs2, NULL, 0, 0, 0},
    {"div", type_r, fmt_rd_rs1_rs2, NULL, 0, 0, 0},
    {"divu", type_r, fmt_rd_rs1_rs2, NULL, 0, 0, 0},
    {"rem", type_r, fmt_rd_rs1_rs2, NULL, 0, 0, 0},
    {"remu", type_r, fmt_rd_rs1_rs2, NULL, 0, 0, 0},
    {"mulw", type_r, fmt_rd_rs1_rs2, NULL, 0, 0, 0},
    {"divw", type_r, fmt_rd_rs1_rs2, NULL, 0, 0, 0},
    {"divuw", type_r, fmt_rd_rs1_rs2, NULL, 0, 0, 0},
    {"remw", type_r, fmt_rd_rs1_rs2, NULL, 0, 0, 0},
    {"remuw", type_r, fmt_rd_rs1_rs2, NULL, 0, 0, 0},
    {"muld", type_r, fmt_rd_rs1_rs2, NULL, 0, 0, 0},
    {"divd", type_r, fmt_rd_rs1_rs2, NULL, 0, 0, 0},
    {"divud", type_r, fmt_rd_rs1_rs2, NULL, 0, 0, 0},
    {"remd", type_r, fmt_rd_rs1_rs2, NULL, 0, 0, 0},
    {"remud", type_r, fmt_rd_rs1_rs2, NULL, 0, 0, 0},
    {"lr.w", type_r_l, fmt_aqrl_rd_rs1, NULL, 0, 0, 0},
    {"sc.w", type_r_a, fmt_aqrl_rd_rs2_rs1, NULL, 0, 0, 0},
    {"amoswap.w", type_r_a, fmt_aqrl_rd_rs2_rs1, NULL, 0, 0, 0},
    {"amoadd.w", type_r_a, fmt_aqrl_rd_rs2_rs1, NULL, 0, 0, 0},
    {"amoxor.w", type_r_a, fmt_aqrl_rd_rs2_rs1, NULL, 0, 0, 0},
    {"amoor.w", type_r_a, fmt_aqrl_rd_rs2_rs1, NULL, 0, 0, 0},
    {"amoand.w", type_r_a, fmt_aqrl_rd_rs2_rs1, NULL, 0, 0, 0},
    {"amomin.w", type_r_a, fmt_aqrl_rd_rs2_rs1, NULL, 0, 0, 0},
    {"amomax.w", type_r_a, fmt_aqrl_rd_rs2_rs1, NULL, 0, 0, 0},
    {"amominu.w", type_r_a, fmt_aqrl_rd_rs2_rs1, NULL, 0, 0, 0},
    {"amomaxu.w", type_r_a, fmt_aqrl_rd_rs2_rs1, NULL, 0, 0, 0},
    {"lr.d", type_r_l, fmt_aqrl_rd_rs1, NULL, 0, 0, 0},
    {"sc.d", type_r_a, fmt_aqrl_rd_rs2_rs1, NULL, 0, 0, 0},
    {"amoswap.d", type_r_a, fmt_aqrl_rd_rs2_rs1, NULL, 0, 0, 0},
    {"amoadd.d", type_r_a, fmt_aqrl_rd_rs2_rs1, NULL, 0, 0, 0},
    {"amoxor.d", type_r_a, fmt_aqrl_rd_rs2_rs1, NULL, 0, 0, 0},
    {"amoor.d", type_r_a, fmt_aqrl_rd_rs2_rs1, NULL, 0, 0, 0},
    {"amoand.d", type_r_a, fmt_aqrl_rd_rs2_rs1, NULL, 0, 0, 0},
    {"amomin.d", type_r_a, fmt_aqrl_rd_rs2_rs1, NULL, 0, 0, 0},
    {"amomax.d", type_r_a, fmt_aqrl_rd_rs2_rs1, NULL, 0, 0, 0},
    {"amominu.d", type_r_a, fmt_aqrl_rd_rs2_rs1, NULL, 0, 0, 0},
    {"amomaxu.d", type_r_a, fmt_aqrl_rd_rs2_rs1, NULL, 0, 0, 0},
    {"lr.q", type_r_l, fmt_aqrl_rd_rs1, NULL, 0, 0, 0},
    {"sc.q", type_r_a, fmt_aqrl_rd_rs2_rs1, NULL, 0, 0, 0},
    {"amoswap.q", type_r_a, fmt_aqrl_rd_rs2_rs1, NULL, 0, 0, 0},
    {"amoadd.q", type_r_a, fmt_aqrl_rd_rs2_rs1, NULL, 0, 0, 0},
    {"amoxor.q", type_r_a, fmt_aqrl_rd_rs2_rs1, NULL, 0, 0, 0},
    {"amoor.q", type_r_a, fmt_aqrl_rd_rs2_rs1, NULL, 0, 0, 0},
    {"amoand.q", type_r_a, fmt_aqrl_rd_rs2_rs1, NULL, 0, 0, 0},
    {"amomin.q", type_r_a, fmt_aqrl_rd_rs2_rs1, NULL, 0, 0, 0},
    {"amomax.q", type_r_a, fmt_aqrl_rd_rs2_rs1, NULL, 0, 0, 0},
    {"amominu.q", type_r_a, fmt_aqrl_rd_rs2_rs1, NULL, 0, 0, 0},
    {"amomaxu.q", type_r_a, fmt_aqrl_rd_rs2_rs1, NULL, 0, 0, 0},
    {"ecall", type_none, fmt_none, NULL, 0, 0, 0},
    {"ebreak", type_none, fmt_none, NULL, 0, 0, 0},
    {"uret", type_none, fmt_none, NULL, 0, 0, 0},
    {"sret", type_none, fmt_none, NULL, 0, 0, 0},
    {"hret", type_none, fmt_none, NULL, 0, 0, 0},
    {"mret", type_none, fmt_none, NULL, 0, 0, 0},
    {"dret", type_none, fmt_none, NULL, 0, 0, 0},
    {"sfence.vm", type_r, fmt_rs1, NULL, 0, 0, 0},
    {"sfence.vma", type_r, fmt_rs1_rs2, NULL, 0, 0, 0},
    {"wfi", type_none, fmt_none, NULL, 0, 0, 0},
    {"csrrw", type_i_csr, fmt_rd_csr_rs1, rvcp_csrrw, 0, 0, 0},
    {"csrrs", type_i_csr, fmt_rd_csr_rs1, rvcp_csrrs, 0, 0, 0},
    {"csrrc", type_i_csr, fmt_rd_csr_rs1, NULL, 0, 0, 0},
    {"csrrwi", type_i_csr, fmt_rd_csr_zimm, rvcp_csrrwi, 0, 0, 0},
    {"csrrsi", type_i_csr, fmt_rd_csr_zimm, NULL, 0, 0, 0},
    {"csrrci", type_i_csr, fmt_rd_csr_zimm, NULL, 0, 0, 0},
    {"flw", type_i, fmt_frd_offset_rs1, NULL, 0, 0, 0},
    {"fsw", type_s, fmt_frs2_offset_rs1, NULL, 0, 0, 0},
    {"fmadd.s", type_r4_m, fmt_rm_frd_frs1_frs2_frs3, NULL, 0, 0, 0},
    {"fmsub.s", type_r4_m, fmt_rm_frd_frs1_frs2_frs3, NULL, 0, 0, 0},
    {"fnmsub.s", type_r4_m, fmt_rm_frd_frs1_frs2_frs3, NULL, 0, 0, 0},
    {"fnmadd.s", type_r4_m, fmt_rm_frd_frs1_frs2_frs3, NULL, 0, 0, 0},
    {"fadd.s", type_r_m, fmt_rm_frd_frs1_frs2, NULL, 0, 0, 0},
    {"fsub.s", type_r_m, fmt_rm_frd_frs1_frs2, NULL, 0, 0, 0},
    {"fmul.s", type_r_m, fmt_rm_frd_frs1_frs2, NULL, 0, 0, 0},
    {"fdiv.s", type_r_m, fmt_rm_frd_frs1_frs2, NULL, 0, 0, 0},
    {"fsgnj.s", type_r, fmt_frd_frs1_frs2, rvcp_fsgnj_s, 0, 0, 0},
    {"fsgnjn.s", type_r, fmt_frd_frs1_frs2, rvcp_fsgnjn_s, 0, 0, 0},
    {"fsgnjx.s", type_r, fmt_frd_frs1_frs2, rvcp_fsgnjx_s, 0, 0, 0},
    {"fmin.s", type_r, fmt_frd_frs1_frs2, NULL, 0, 0, 0},
    {"fmax.s", type_r, fmt_frd_frs1_frs2, NULL, 0, 0, 0},
    {"fsqrt.s", type_r_m, fmt_rm_frd_frs1, NULL, 0, 0, 0},
    {"fle.s", type_r, fmt_rd_frs1_frs2, NULL, 0, 0, 0},
    {"flt.s", type_r, fmt_rd_frs1_frs2, NULL, 0, 0, 0},
    {"feq.s", type_r, fmt_rd_frs1_frs2, NULL, 0, 0, 0},
    {"fcvt.w.s", type_r_m, fmt_rm_rd_frs1, NULL, 0, 0, 0},
    {"fcvt.wu.s", type_r_m, fmt_rm_rd_frs1, NULL, 0, 0, 0},
    {"fcvt.s.w", type_r_m, fmt_rm_frd_rs1, NULL, 0, 0, 0},
    {"fcvt.s.wu", type_r_m, fmt_rm_frd_rs1, NULL, 0, 0, 0},
    {"fmv.x.s", type_r, fmt_rd_frs1, NULL, 0, 0, 0},
    {"fclass.s", type_r, fmt_rd_frs1, NULL, 0, 0, 0},
    {"fmv.s.x", type_r, fmt_frd_rs1, NULL, 0, 0, 0},
    {"fcvt.l.s", type_r_m, fmt_rm_rd_frs1, NULL, 0, 0, 0},
    {"fcvt.lu.s", type_r_m, fmt_rm_rd_frs1, NULL, 0, 0, 0},
    {"fcvt.s.l", type_r_m, fmt_rm_frd_rs1, NULL, 0, 0, 0},
    {"fcvt.s.lu", type_r_m, fmt_rm_frd_rs1, NULL, 0, 0, 0},
    {"fld", type_i, fmt_frd_offset_rs1, NULL, 0, 0, 0},
    {"fsd", type_s, fmt_frs2_offset_rs1, NULL, 0, 0, 0},
    {"fmadd.d", type_r4_m, fmt_rm_frd_frs1_frs2_frs3, NULL, 0, 0, 0},
    {"fmsub.d", type_r4_m, fmt_rm_frd_frs1_frs2_frs3, NULL, 0, 0, 0},
    {"fnmsub.d", type_r4_m, fmt_rm_frd_frs1_frs2_frs3, NULL, 0, 0, 0},
    {"fnmadd.d", type_r4_m, fmt_rm_frd_frs1_frs2_frs3, NULL, 0, 0, 0},
    {"fadd.d", type_r_m, fmt_rm_frd_frs1_frs2, NULL, 0, 0, 0},
    {"fsub.d", type_r_m, fmt_rm_frd_frs1_frs2, NULL, 0, 0, 0},
    {"fmul.d", type_r_m, fmt_rm_frd_frs1_frs2, NULL, 0, 0, 0},
    {"fdiv.d", type_r_m, fmt_rm_frd_frs1_frs2, NULL, 0, 0, 0},
    {"fsgnj.d", type_r, fmt_frd_frs1_frs2, rvcp_fsgnj_d, 0, 0, 0},
    {"fsgnjn.d", type_r, fmt_frd_frs1_frs2, rvcp_fsgnjn_d, 0, 0, 0},
    {"fsgnjx.d", type_r, fmt_frd_frs1_frs2, rvcp_fsgnjx_d, 0, 0, 0},
    {"fmin.d", type_r, fmt_frd_frs1_frs2, NULL, 0, 0, 0},
    {"fmax.d", type_r, fmt_frd_frs1_frs2, NULL, 0, 0, 0},
    {"fcvt.s.d", type_r_m, fmt_rm_frd_frs1, NULL, 0, 0, 0},
    {"fcvt.d.s", type_r_m, fmt_rm_frd_frs1, NULL, 0, 0, 0},
    {"fsqrt.d", type_r_m, fmt_rm_frd_frs1, NULL, 0, 0, 0},
    {"fle.d", type_r, fmt_rd_frs1_frs2, NULL, 0, 0, 0},
    {"flt.d", type_r, fmt_rd_frs1_frs2, NULL, 0, 0, 0},
    {"feq.d", type_r, fmt_rd_frs1_frs2, NULL, 0, 0, 0},
    {"fcvt.w.d", type_r_m, fmt_rm_rd_frs1, NULL, 0, 0, 0},
    {"fcvt.wu.d", type_r_m, fmt_rm_rd_frs1, NULL, 0, 0, 0},
    {"fcvt.d.w", type_r_m, fmt_rm_frd_rs1, NULL, 0, 0, 0},
    {"fcvt.d.wu", type_r_m, fmt_rm_frd_rs1, NULL, 0, 0, 0},
    {"fclass.d", type_r, fmt_rd_frs1, NULL, 0, 0, 0},
    {"fcvt.l.d", type_r_m, fmt_rm_rd_frs1, NULL, 0, 0, 0},
    {"fcvt.lu.d", type_r_m, fmt_rm_rd_frs1, NULL, 0, 0, 0},
    {"fmv.x.d", type_r, fmt_rd_frs1, NULL, 0, 0, 0},
    {"fcvt.d.l", type_r_m, fmt_rm_frd_rs1, NULL, 0, 0, 0},
    {"fcvt.d.lu", type_r_m, fmt_rm_frd_rs1, NULL, 0, 0, 0},
    {"fmv.d.x", type_r, fmt_frd_rs1, NULL, 0, 0, 0},
    {"flq", type_i, fmt_frd_offset_rs1, NULL, 0, 0, 0},
    {"fsq", type_s, fmt_frs2_offset_rs1, NULL, 0, 0, 0},
    {"fmadd.q", type_r4_m, fmt_rm_frd_frs1_frs2_frs3, NULL, 0, 0, 0},
    {"fmsub.q", type_r4_m, fmt_rm_frd_frs1_frs2_frs3, NULL, 0, 0, 0},
    {"fnmsub.q", type_r4_m, fmt_rm_frd_frs1_frs2_frs3, NULL, 0, 0, 0},
    {"fnmadd.q", type_r4_m, fmt_rm_frd_frs1_frs2_frs3, NULL, 0, 0, 0},
    {"fadd.q", type_r_m, fmt_rm_frd_frs1_frs2, NULL, 0, 0, 0},
    {"fsub.q", type_r_m, fmt_rm_frd_frs1_frs2, NULL, 0, 0, 0},
    {"fmul.q", type_r_m, fmt_rm_frd_frs1_frs2, NULL, 0, 0, 0},
    {"fdiv.q", type_r_m, fmt_rm_frd_frs1_frs2, NULL, 0, 0, 0},
    {"fsgnj.q", type_r, fmt_frd_frs1_frs2, rvcp_fsgnj_q, 0, 0, 0},
    {"fsgnjn.q", type_r, fmt_frd_frs1_frs2, rvcp_fsgnjn_q, 0, 0, 0},
    {"fsgnjx.q", type_r, fmt_frd_frs1_frs2, rvcp_fsgnjx_q, 0, 0, 0},
    {"fmin.q", type_r, fmt_frd_frs1_frs2, NULL, 0, 0, 0},
    {"fmax.q", type_r, fmt_frd_frs1_frs2, NULL, 0, 0, 0},
    {"fcvt.s.q", type_r_m, fmt_rm_frd_frs1, NULL, 0, 0, 0},
    {"fcvt.q.s", type_r_m, fmt_rm_frd_frs1, NULL, 0, 0, 0},
    {"fcvt.d.q", type_r_m, fmt_rm_frd_frs1, NULL, 0, 0, 0},
    {"fcvt.q.d", type_r_m, fmt_rm_frd_frs1, NULL, 0, 0, 0},
    {"fsqrt.q", type_r_m, fmt_rm_frd_frs1, NULL, 0, 0, 0},
    {"fle.q", type_r, fmt_rd_frs1_frs2, NULL, 0, 0, 0},
    {"flt.q", type_r, fmt_rd_frs1_frs2, NULL, 0, 0, 0},
    {"feq.q", type_r, fmt_rd_frs1_frs2, NULL, 0, 0, 0},
    {"fcvt.w.q", type_r_m, fmt_rm_rd_frs1, NULL, 0, 0, 0},
    {"fcvt.wu.q", type_r_m, fmt_rm_rd_frs1, NULL, 0, 0, 0},
    {"fcvt.q.w", type_r_m, fmt_rm_frd_rs1, NULL, 0, 0, 0},
    {"fcvt.q.wu", type_r_m, fmt_rm_frd_rs1, NULL, 0, 0, 0},
    {"fclass.q", type_r, fmt_rd_frs1, NULL, 0, 0, 0},
    {"fcvt.l.q", type_r_m, fmt_rm_rd_frs1, NULL, 0, 0, 0},
    {"fcvt.lu.q", type_r_m, fmt_rm_rd_frs1, NULL, 0, 0, 0},
    {"fcvt.q.l", type_r_m, fmt_rm_frd_rs1, NULL, 0, 0, 0},
    {"fcvt.q.lu", type_r_m, fmt_rm_frd_rs1, NULL, 0, 0, 0},
    {"fmv.x.q", type_r, fmt_rd_frs1, NULL, 0, 0, 0},
    {"fmv.q.x", type_r, fmt_frd_rs1, NULL, 0, 0, 0},
    {"c.addi4spn", type_ciw_4spn, fmt_rd_rs1_imm, NULL, op_addi, op_addi,
     op_addi, rvcd_imm_nz},
    {"c.fld", type_cl_ld, fmt_frd_offset_rs1, NULL, op_fld, op_fld, 0},
    {"c.lw", type_cl_lw, fmt_rd_offset_rs1, NULL, op_lw, op_lw, op_lw},
    {"c.flw", type_cl_lw, fmt_frd_offset_rs1, NULL, op_flw, 0, 0},
    {"c.fsd", type_cs_sd, fmt_frs2_offset_rs1, NULL, op_fsd, op_fsd, 0},
    {"c.sw", type_cs_sw, fmt_rs2_offset_rs1, NULL, op_sw, op_sw, op_sw},
    {"c.fsw", type_cs_sw, fmt_frs2_offset_rs1, NULL, op_fsw, 0, 0},
    {"c.nop", type_ci_none, fmt_none, NULL, op_addi, op_addi, op_addi},
    {"c.addi", type_ci, fmt_rd_rs1_imm, NULL, op_addi, op_addi, op_addi,
     rvcd_imm_nz_hint},
    {"c.jal", type_cj_jal, fmt_rd_offset, NULL, op_jal, 0, 0},
    {"c.li", type_ci_li, fmt_rd_rs1_imm, NULL, op_addi, op_addi, op_addi},
    {"c.addi16sp", type_ci_16sp, fmt_rd_rs1_imm, NULL, op_addi, op_addi,
     op_addi, rvcd_imm_nz},
    {"c.lui", type_ci_lui, fmt_rd_imm, NULL, op_lui, op_lui, op_lui,
     rvcd_imm_nz},
    {"c.srli", type_cb_sh6, fmt_rd_rs1_imm, NULL, op_srli, op_srli, op_srli,
     rvcd_imm_nz},
    {"c.srai", type_cb_sh6, fmt_rd_rs1_imm, NULL, op_srai, op_srai, op_srai,
     rvcd_imm_nz},
    {"c.andi", type_cb_imm, fmt_rd_rs1_imm, NULL, op_andi, op_andi, op_andi,
     rvcd_imm_nz},
    {"c.sub", type_cs, fmt_rd_rs1_rs2, NULL, op_sub, op_sub, op_sub},
    {"c.xor", type_cs, fmt_rd_rs1_rs2, NULL, op_xor, op_xor, op_xor},
    {"c.or", type_cs, fmt_rd_rs1_rs2, NULL, op_or, op_or, op_or},
    {"c.and", type_cs, fmt_rd_rs1_rs2, NULL, op_and, op_and, op_and},
    {"c.subw", type_cs, fmt_rd_rs1_rs2, NULL, op_subw, op_subw, op_subw},
    {"c.addw", type_cs, fmt_rd_rs1_rs2, NULL, op_addw, op_addw, op_addw},
    {"c.j", type_cj, fmt_rd_offset, NULL, op_jal, op_jal, op_jal},
    {"c.beqz", type_cb, fmt_rs1_rs2_offset, NULL, op_beq, op_beq, op_beq},
    {"c.bnez", type_cb, fmt_rs1_rs2_offset, NULL, op_bne, op_bne, op_bne},
    {"c.slli", type_ci_sh6, fmt_rd_rs1_imm, NULL, op_slli, op_slli, op_slli,
     rvcd_imm_nz},
    {"c.fldsp", type_ci_ldsp, fmt_frd_offset_rs1, NULL, op_fld, op_fld, op_fld},
    {"c.lwsp", type_ci_lwsp, fmt_rd_offset_rs1, NULL, op_lw, op_lw, op_lw},
    {"c.flwsp", type_ci_lwsp, fmt_frd_offset_rs1, NULL, op_flw, 0, 0},
    {"c.jr", type_cr_jr, fmt_rd_rs1_offset, NULL, op_jalr, op_jalr, op_jalr},
    {"c.mv", type_cr_mv, fmt_rd_rs1_rs2, NULL, op_addi, op_addi, op_addi},
    {"c.ebreak", type_ci_none, fmt_none, NULL, op_ebreak, op_ebreak, op_ebreak},
    {"c.jalr", type_cr_jalr, fmt_rd_rs1_offset, NULL, op_jalr, op_jalr,
     op_jalr},
    {"c.add", type_cr, fmt_rd_rs1_rs2, NULL, op_add, op_add, op_add},
    {"c.fsdsp", type_css_sdsp, fmt_frs2_offset_rs1, NULL, op_fsd, op_fsd,
     op_fsd},
    {"c.swsp", type_css_swsp, fmt_rs2_offset_rs1, NULL, op_sw, op_sw, op_sw},
    {"c.fswsp", type_css_swsp, fmt_frs2_offset_rs1, NULL, op_fsw, 0, 0},
    {"c.ld", type_cl_ld, fmt_rd_offset_rs1, NULL, 0, op_ld, op_ld},
    {"c.sd", type_cs_sd, fmt_rs2_offset_rs1, NULL, 0, op_sd, op_sd},
    {"c.addiw", type_ci, fmt_rd_rs1_imm, NULL, 0, op_addiw, op_addiw},
    {"c.ldsp", type_ci_ldsp, fmt_rd_offset_rs1, NULL, 0, op_ld, op_ld},
    {"c.sdsp", type_css_sdsp, fmt_rs2_offset_rs1, NULL, 0, op_sd, op_sd},
    {"c.lq", type_cl_lq, fmt_rd_offset_rs1, NULL, 0, 0, op_lq},
    {"c.sq", type_cs_sq, fmt_rs2_offset_rs1, NULL, 0, 0, op_sq},
    {"c.lqsp", type_ci_lqsp, fmt_rd_offset_rs1, NULL, 0, 0, op_lq},
    {"c.sqsp", type_css_sqsp, fmt_rs2_offset_rs1, NULL, 0, 0, op_sq},
    {"nop", type_i, fmt_none, NULL, 0, 0, 0},
    {"mv", type_i, fmt_rd_rs1, NULL, 0, 0, 0},
    {"not", type_i, fmt_rd_rs1, NULL, 0, 0, 0},
    {"neg", type_r, fmt_rd_rs2, NULL, 0, 0, 0},
    {"negw", type_r, fmt_rd_rs2, NULL, 0, 0, 0},
    {"sext.w", type_i, fmt_rd_rs1, NULL, 0, 0, 0},
    {"seqz", type_i, fmt_rd_rs1, NULL, 0, 0, 0},
    {"snez", type_r, fmt_rd_rs2, NULL, 0, 0, 0},
    {"sltz", type_r, fmt_rd_rs1, NULL, 0, 0, 0},
    {"sgtz", type_r, fmt_rd_rs2, NULL, 0, 0, 0},
    {"fmv.s", type_r, fmt_rd_rs1, NULL, 0, 0, 0},
    {"fabs.s", type_r, fmt_rd_rs1, NULL, 0, 0, 0},
    {"fneg.s", type_r, fmt_rd_rs1, NULL, 0, 0, 0},
    {"fmv.d", type_r, fmt_rd_rs1, NULL, 0, 0, 0},
    {"fabs.d", type_r, fmt_rd_rs1, NULL, 0, 0, 0},
    {"fneg.d", type_r, fmt_rd_rs1, NULL, 0, 0, 0},
    {"fmv.q", type_r, fmt_rd_rs1, NULL, 0, 0, 0},
    {"fabs.q", type_r, fmt_rd_rs1, NULL, 0, 0, 0},
    {"fneg.q", type_r, fmt_rd_rs1, NULL, 0, 0, 0},
    {"beqz", type_sb, fmt_rs1_offset, NULL, 0, 0, 0},
    {"bnez", type_sb, fmt_rs1_offset, NULL, 0, 0, 0},
    {"blez", type_sb, fmt_rs2_offset, NULL, 0, 0, 0},
    {"bgez", type_sb, fmt_rs1_offset, NULL, 0, 0, 0},
    {"bltz", type_sb, fmt_rs1_offset, NULL, 0, 0, 0},
    {"bgtz", type_sb, fmt_rs2_offset, NULL, 0, 0, 0},
    {"ble", type_sb, fmt_rs2_rs1_offset, NULL, 0, 0, 0},
    {"bleu", type_sb, fmt_rs2_rs1_offset, NULL, 0, 0, 0},
    {"bgt", type_sb, fmt_rs2_rs1_offset, NULL, 0, 0, 0},
    {"bgtu", type_sb, fmt_rs2_rs1_offset, NULL, 0, 0, 0},
    {"j", type_uj, fmt_offset, NULL, 0, 0, 0},
    {"ret", type_i, fmt_none, NULL, 0, 0, 0},
    {"jr", type_i, fmt_rs1, NULL, 0, 0, 0},
    {"rdcycle", type_i_csr, fmt_rd, NULL, 0, 0, 0},
    {"rdtime", type_i_csr, fmt_rd, NULL, 0, 0, 0},
    {"rdinstret", type_i_csr, fmt_rd, NULL, 0, 0, 0},
    {"rdcycleh", type_i_csr, fmt_rd, NULL, 0, 0, 0},
    {"rdtimeh", type_i_csr, fmt_rd, NULL, 0, 0, 0},
    {"rdinstreth", type_i_csr, fmt_rd, NULL, 0, 0, 0},
    {"frcsr", type_i_csr, fmt_rd, NULL, 0, 0, 0},
    {"frrm", type_i_csr, fmt_rd, NULL, 0, 0, 0},
    {"frflags", type_i_csr, fmt_rd, NULL, 0, 0, 0},
    {"fscsr", type_i_csr, fmt_rd_rs1, NULL, 0, 0, 0},
    {"fsrm", type_i_csr, fmt_rd_rs1, NULL, 0, 0, 0},
    {"fsflags", type_i_csr, fmt_rd_rs1, NULL, 0, 0, 0},
    {"fsrmi", type_i_csr, fmt_rd_zimm, NULL, 0, 0, 0},
    {"fsflagsi", type_i_csr, fmt_rd_zimm, NULL, 0, 0, 0},
};
...
#define INST_LEN_2 ("%04h" PRIx32 "              ")
#define INST_LEN_4 ("%08" PRIx32 "          ")
#define INST_LEN_6 ("%012" PRIx64 "      ")
#define INST_LEN_8 ("%016" PRIx64 "  ")

/* Given a printout character string for each instruction, the printout is
 * completed in a function through the processing of the character string */
static void rv_inst_format(char *buf, size_t buflen, size_t tab,
  ...
  written to the array, and a null character is written at the end of the
  characters actually written into the array */
    snprintf(buf, buflen, INST_LEN_2, (int32_t)instInfo->inst);
    break;
  case 4:
  ...
  case 6:
    ...
    break;
  default:
    snprintf(buf, buflen, INST_LEN_8, instInfo->inst);
    break;
  }
